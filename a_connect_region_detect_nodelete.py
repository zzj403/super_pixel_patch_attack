...
def count_score_yolov4(max_total_area_rate, selected_path, max_patch_number, json_name):
...
def connected_domin_detect_and_score(input_img, max_total_area_rate, max_patch_number):
    ...
    for i in range(1, label_max_number+1):
        ...
        total_area = total_area + now_count_area
...
if __name__ == '__main__':
    ...
    x = count_score_yolov4(MAX_TOTAL_AREA_RATE, selected_path, max_patch_number,json_name)
