    ...
    def train(self):
        ...
        for img_name in img_list:
            ...
            with torch.no_grad():
                ...
                print(graph_0.getVertex(151).connectedTo)
                neighbor_list = list(graph_0.getVertex(151).connectedTo.keys())
                var = list(graph_0.getVertex(151).connectedTo.keys())[0].id



                for k in range(unique_segments_num):
                    # print('list_len:', len(unique_segments_cover))
