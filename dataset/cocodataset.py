...
class COCODataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img, info_img = preprocess(img, self.img_size, jitter=False,
        ...
        # img4 = transforms.ToPILImage('RGB')(torch.from_numpy(img).detach().cpu())
        # img4.show()
        ...
        if len(labels) > 0:
            ...
            if 'YOLO' in self.model_type:
                labels = label2yolobox(labels, info_img, self.img_size, lrflip=False)
